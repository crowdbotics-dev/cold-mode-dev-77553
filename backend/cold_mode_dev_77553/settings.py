"""
Django settings for cold_mode_dev_77553 project.
...
ROOT_URLCONF = 'cold_mode_dev_77553.urls'
...
WSGI_APPLICATION = 'cold_mode_dev_77553.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_mode_dev_77553 API",
    "DESCRIPTION": "API documentation for cold_mode_dev_77553 App",
    "VERSION": "v1",
}
